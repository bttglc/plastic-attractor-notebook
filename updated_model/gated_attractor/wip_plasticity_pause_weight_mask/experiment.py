...
Companion to model.py in this same folder; see its header for the full
context. This is experiment.py as it stood when that pause was last tested
and then reverted from the active package.
